...
${checkbox_4}    //*[@name="unsatisfactory-service"]//parent::label  
...
* Test Cases *
TC06 User proceeds to close the account by confirming the prompt message by clicking on the “Close Account” button.
